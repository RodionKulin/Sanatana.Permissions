...
{
    /// <summary>
    /// Extension methods to make working with Enum values easier. From http://hugoware.net/blog/enumeration-extensions-2-0.
    /// </summary>
    public static class EnumerationExtensions
    {
        ...
        /// </summary>
        public static bool Missing<T>(this Enum value, T check)
        {
            return !EnumerationExtensions.Has<T>(value, check);
        }
